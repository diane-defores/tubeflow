...
class StatsScreen extends ConsumerWidget {
  ...
  Widget _buildDailySummaryCard(BuildContext context,
      Map<String, dynamic>? quotaData, List<dynamic> dailyHistory) {
              ...
              child: Row(
                ...
                children: List.generate(7, (index) {
                  ...
                  if (index < dailyHistory.length) {
                    ...
                    final maxUsed = dailyHistory
                        .fold<double>(0, (a, b) {
                          final v = (b as num?)?.toDouble() ?? 0;
                          return v > a ? v : a;
                        });
                    heightFactor =
                        maxUsed > 0 ? (dayUsed / maxUsed).clamp(0.05, 1.0) : 0.1;
                  }
  ...
  Widget _buildRecentCallsSection(
      BuildContext context, List<dynamic> recentCalls) {
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
          ...
          children: [
            ...
            if (recentCalls.isEmpty)
              const Padding(
                ...
                child: Center(
                  child: Text('No recent API calls',
                      style: TextStyle(color: Colors.grey)),
                ),
              )
            else
              ...recentCalls.take(20).map((call) {
                final callMap = call is Map<String, dynamic> ? call : <String, dynamic>{};
                ...
                final minutesAgo = timestamp > 0
                    ...
                    : 0;
                final timeStr =
                    minutesAgo < 60 ? '${minutesAgo}m ago' : '${minutesAgo ~/ 60}h ago';
