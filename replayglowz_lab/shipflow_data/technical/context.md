...
`replayglowz_lab` is a standalone Python/FastAPI transcript worker for ReplayGlowz. It exists to offload CPU-heavy and binary-dependent transcription work that should not run inside Convex.
