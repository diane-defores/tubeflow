...
depends_on:
  - artifact: "replayglowz_app/shipflow_data/business/product.md"
    artifact_version: "1.0.0"
...
Canonical product truth is `replayglowz_app/shipflow_data/business/product.md`. This repository must stay aligned with that contract and avoid introducing a parallel product definition.
...
- Any product-level conflict resolves in favor of `replayglowz_app/shipflow_data/business/product.md`.
