...
next_step: "Keep user-facing product claims in tubeflow-app and limit this doc to worker scope."
---
...
`tubeflow_lab` documents a backend and experimental worker surface. The user-facing product truth is in `tubeflow-app`.
